...
const FAQS: [string, string][] = [
  ...
  [
    ...
    "The plan itself decides, not the wording of your request. Changing finishes, fixtures, paint, furniture, tile or lighting is minor and always free and unlimited \u2014 those don\u2019t alter the plan. So are small adjustments: sliding a window, nudging a wall a few inches, moving a door. A revision counts as major when it changes the home in a way a builder would notice: adding or removing a room or a floor, relocating a room across the plan, changing the footprint, or a real change in living area. Those use one of the revision rounds included with your project license, and you\u2019re told which rule applied and how many rounds remain before anything is spent. One exception: accepting a value-engineering suggestion never costs a round, however much it changes \u2014 those are our own recommendations for getting back inside your budget, and charging you for taking them would be perverse. Projects without a license aren\u2019t metered at all.",
  ],
  [
